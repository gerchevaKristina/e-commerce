...
if (isset($_REQUEST['custid'])) {
  $customers_custnum = $_REQUEST['custid'];
}
...
while ($row = mysql_fetch_array($results)) {
  ...
  $message .= "
    ...
    <tr>
      <td colspan=\"3\" align=\"right\">
        <strong>Your final total is:</strong>
      </td>
...
echo "<h1><strong>KG Beauty</strong></h1>";
echo "<strong>Order Confirmation and Receipt</strong><br><br>";
